...
TIP: Be sure to provide links to as many media sources as possible for your project. By providing more easily accessible media, you can increase the likelihood and frequency that the marketing manager will select your content.
